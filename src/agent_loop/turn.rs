...
use crate::agent_loop::formatting::{
    format_tool_result, preview_text, sanitize_assistant_response_text,
...
mod tests {
    ...
    use crate::agent_loop::compaction::truncate_compaction_summary_input;
    use crate::agent_loop::formatting::{
        message_to_archive_text, message_to_text, strip_thinking,
    };
    use crate::agent_loop::guards::is_declarative_only_reply;
