...
mod tests {
    ...
    use crate::agent_loop::test_support::{
        DeltaEmittingProvider, DeltaThenFailProvider, DeltaThenThinkingProvider, FailingProvider,
        FakeProvider, RecordingProvider, build_state_with_provider, cli_context,
    };
